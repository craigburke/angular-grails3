describe('core sort directives: ', function() {
    ...
    beforeEach(module('myApp.core.directives.sort'));
    ...
    describe('sortHeader: ', function () {
        ...
        beforeEach(function () {
            $httpBackend.expectGET('/my-app/core/directives/sortable-column.html').respond("<th>{{title}}</th>");

            var scope = $rootScope.$new();
            scope.onSort = onSort;
            var element = $compile("<tr sort-header ng-model='sort' on-sort='onSort()'>                 <th sortable-column title='Id' property='id'></th>             </tr>")(scope);
