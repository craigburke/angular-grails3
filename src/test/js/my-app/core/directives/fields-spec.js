describe('core fields directives: ', function() {

    var $rootScope, $compile, $httpBackend;

    beforeEach(module('ui.bootstrap'));
    beforeEach(module('myApp.core.directives.fields'));
    ...
    describe('date-field', function() {
        ...
        beforeEach(function () {
            $httpBackend.expectGET('/my-app/core/directives/fields/date-field.html').respond("<input datepicker-popup='' ng-model='ngModel' />");
