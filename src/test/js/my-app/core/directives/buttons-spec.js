describe('core button directives: ', function() {
	...
	beforeEach(module('myApp.core.directives.buttons'));
	beforeEach(module('myApp.core.services.crud'));
    ...
    describe('create button: ', function() {
        ...
        beforeEach(function () {
            $httpBackend.expectGET('/my-app/core/directives/buttons/create-button.html').respond("<button>Create</button>");
    ...
    describe('edit button: ', function() {
        ...
        beforeEach(function () {
            $httpBackend.expectGET('/my-app/core/directives/buttons/edit-button.html').respond("<button>Edit</button>");
