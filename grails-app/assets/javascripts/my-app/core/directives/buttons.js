//= require_self
//= require_tree /my-app/core/directives/templates/buttons
    ...
    return {
        ...
        templateUrl: function (element, attrs) {
            switch (attrs.crudButton) {
                case "create":
                    return "/my-app/core/directives/buttons/create-button.html";
                case "edit":
                    return "/my-app/core/directives/buttons/edit-button.html";
                case "delete":
                    return "/my-app/core/directives/buttons/delete-button.html";
                case "save":
                    return "/my-app/core/directives/buttons/save-button.html";
            }
...
angular.module('myApp.core.directives.buttons', ['myApp.core.services'])
